...
public class ColorPickerView: UIControl
{
    ...
    fileprivate lazy var centerView: UIView = {
        ...
        centerView.backgroundColor = #colorLiteral(red: 0.3450980392, green: 0.3294117647, blue: 0.768627451, alpha: 1)
    ...
    fileprivate lazy var whiteCenterView: UIView = {
        ...
        whiteCenterView.backgroundColor = #colorLiteral(red: 0.3450980392, green: 0.3294117647, blue: 0.768627451, alpha: 1)
